...
const ShortenItem = ({ originalUrl, shortUrl, clickCount, createdDate }) => {
  ...
  return (
    <div className={`bg-gray-50 shadow-lg border border-dotted  border-gray-500 px-6 sm:py-1 py-3 rounded-md  transition-all duration-100 `}>
    <div className={`flex sm:flex-row flex-col  sm:justify-between w-full sm:gap-0 gap-5 py-5 `}>
      <div className="flex-1 sm:space-y-1 max-w-full overflow-x-auto overflow-y-hidden ">
        <div className="text-black pb-1 sm:pb-0   flex items-center gap-2 ">
        ...
        <div className="flex items-center gap-1 ">
            <h3 className=" text-gray-700 font-[400] text-[17px] ">
              {originalUrl}
            </h3>
          </div>

          <div className="flex   items-center gap-8 pt-6 ">
            <div className="flex gap-1  items-center font-semibold  text-black">
              <span>
        ...
        <div className="flex  flex-1  sm:justify-end items-center gap-4">
            ...
            >
                <div className="flex cursor-pointer gap-1 items-center bg-btnColor py-2  font-semibold shadow-md shadow-gray-500 px-6 rounded-md text-white ">
            ...
            <div
                ...
                className="flex cursor-pointer gap-1 items-center bg-black py-2 font-semibold shadow-md shadow-gray-500 px-6 rounded-md text-white "
            >
                ...
                <div className="min-h-[calc(450px-140px)] flex justify-center items-center w-full">
                    ...
                    <>{analyticsData.length === 0 && (
                        <div className="absolute flex flex-col  justify-center sm:items-center items-end  w-full left-0 top-0 bottom-0 right-0 m-auto">
                            <h1 className=" text-gray-800 font-serif sm:text-2xl text-[15px] font-bold mb-1">
                                No Data For This Time Period
                            </h1>
                            <h3 className="sm:w-96 w-[90%] sm:ml-0 pl-6 text-center sm:text-lg text-[12px] text-gray-600 ">
